...
def login_view(request):
    ...
    if user is None:
        ...
        if existing_user is not None:
            user = authenticate(
                request, username=existing_user.get_username(), password=password
            )
...
def detalle_niño(request, pk):
    ...
    if request.method == "PUT":
        ...
        niño.fecha_nacimiento = request.data.get(
        ...
        niño.nombre_informante = request.data.get(
            "nombre_informante", niño.nombre_informante
        )
        niño.relacion_informante = request.data.get(
            "relacion_informante", niño.relacion_informante
        )
        niño.periodo_conoce_nino = request.data.get(
            "periodo_conoce_nino", niño.periodo_conoce_nino
        )
        niño.save()
