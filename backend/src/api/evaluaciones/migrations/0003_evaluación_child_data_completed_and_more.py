    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("SYSTEM_ASSISTED", "Sistema asistido"),
                    ("CHILD_INTERACTION", "Interacción del niño"),
                    ("ADULT_ASSISTED", "Adulto acompañante"),
                    ("PSYCHOLOGIST_REVIEW", "Revisión del psicólogo"),
                ],
                default="SYSTEM_AUTO",
                max_length=40,
            ),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("PSYCHOLOGIST_CONFIRMED", "Confirmada por psicólogo"),
                    ("PSYCHOLOGIST_CORRECTED", "Corregida por psicólogo"),
                    ("REJECTED", "Rechazada"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("INTERACTIVO_AUTO", "Interactivo automático"),
                            ("INTERACTIVO_ASISTIDO", "Interactivo asistido"),
                            ("EVIDENCIA_DIFERIDA", "Evidencia diferida"),
                            ("OBSERVACION_FISICA", "Observación física"),
                            ("PREGUNTA_CUIDADOR", "Pregunta al cuidador"),
                            ("MANUAL_GUIADO", "Manual guiado"),
                        ],
                        default="MANUAL_GUIADO",
                        max_length=40,
                    ),
                ),
                (
                    "pantalla_nino",
                    models.CharField(default="INSTRUCCION_SIMPLE", max_length=40),
                ),
                (
                    "estado",
                    models.CharField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="evaluaciones.evaluacionitem",
            ),
        ),
        migrations.CreateModel(
            name="Evidencia",
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("LOG", "Log"),
                            ("TIME_EVENT", "Evento de tiempo"),
                            ("SCREENSHOT", "Captura"),
                            ("AUDIO", "Audio"),
                            ("VIDEO", "Video"),
                            ("CAMERA_FRAME", "Frame de cámara"),
                ...
                (
                    "captured_by",
                    models.CharField(default="CHILD_DEVICE", max_length=40),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["evaluación", "area", "estado"],
                name="evaluacion__evaluac_f96fc9_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="evaluacionitem",
            index=models.Index(
                fields=["evaluación", "item_id"], name="evaluacion__evaluac_2a3341_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["evaluación", "type", "created_at"],
                name="evidencias_evaluac_b2264e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="interactionevent",
            index=models.Index(
                fields=["evaluación", "event_type", "timestamp"],
                name="interaction_evaluac_88e5a3_idx",
            ),
        ),
    ]
