...
urlpatterns = [
    path(
        "evidence-policies/",
        views.list_evidence_policies,
        name="list_evidence_policies",
    ),
    path(
        "evidence-policies/<str:item_id>/",
        views.evidence_policy_detail,
        name="evidence_policy_detail",
    ),
    ...
    path(
        "session/<str:session_code>/complete-child-data/",
        views.complete_child_data,
        name="complete_child_data",
    ),
    path(
    ...
    path(
        "session/<str:session_code>/finish/",
        views.finish_child_session,
        name="finish_child_session",
    ),
    path(
        "session/<str:session_code>/current-task/",
        views.tarea_actual_por_session,
        name="tarea_actual_por_session",
    ),
    path(
        "session/<str:session_code>/respuesta/",
        views.registrar_respuesta_por_session,
        name="registrar_respuesta_por_session",
    ),
    ...
    path(
        "<uuid:pk>/items/<str:item_id>/auto-result/",
        views.registrar_auto_result,
        name="registrar_auto_result",
    ),
    path(
        "<uuid:pk>/items/<str:item_id>/events/",
        views.registrar_evento_item,
        name="registrar_evento_item",
    ),
    path(
        "<uuid:pk>/items/<str:item_id>/evidence/",
        views.manejar_evidencia_item,
        name="manejar_evidencia_item",
    ),
    path(
        "evidencias/<int:evidence_id>/download/",
    ...
    path(
        "<uuid:pk>/score/preliminary/",
        views.calcular_puntuación_preliminar,
        name="calcular_puntuación_preliminar",
    ),
    path(
        "<uuid:pk>/score/validated/",
        views.calcular_puntuación_validada,
        name="calcular_puntuación_validada",
    ),
    path(
        "<uuid:pk>/score/comparison/",
        views.comparación_resultados,
        name="comparación_resultados",
    ),
    ...
    path(
        "<uuid:pk>/resultados/<uuid:rid>/",
        views.ajustar_resultado,
        name="ajustar_resultado",
    ),
    path("<uuid:pk>/reglas-status/", views.reglas_status, name="reglas_status"),
    path("calcular-online/", views.calcular_online, name="calcular_online"),
]
